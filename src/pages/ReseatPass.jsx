...
import reast from '../assests/reast.png'
...
const handleInp =()=>{
  ...
  return (
    ...
    <Link className='mb-4 text-decoration-none text-black' to='/login' >
...
<div className='d-flex flex-column'>
    ...
    <input  type={showPassword ? "text" : "password"} className=' mt-4 p-2 form-control postion-relative'placeholder='ادخل كلمه المرور الجديده  '
    ...
    <input type='password' className='inpforgot mt-4 p-2 form-control'placeholder='ادخل كلمه المرور الخاصه بك  'onChange={(e)=>{setRepPass(e.target.value)}}/>
    <button className='text-white btn-forgot w-100' onClick={()=>{handleInp()}} >تأكيد  كلمه المرور </button>
</div>
</form>
      </div>
      <div className='col-lg-6 text-center mb-4 mb-lg-0'>
      <img src={reast} alt='' className='img-fluid'/>
      </div>
